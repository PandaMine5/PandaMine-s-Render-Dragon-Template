...
vec2 ivec2_splat(float _x) { return ivec2(_x, _x); }
vec3 ivec3_splat(float _x) { return ivec3(_x, _x, _x); }
vec4 ivec4_splat(float _x) { return ivec4(_x, _x, _x, _x); }


vec2 uvec2_splat(float _x) { return uvec2(_x, _x); }
vec3 uvec3_splat(float _x) { return uvec3(_x, _x, _x); }
vec4 uvec4_splat(float _x) { return uvec4(_x, _x, _x, _x); }


vec2 bvec2_splat(float _x) { return bvec2(_x, _x); }
vec3 bvec3_splat(float _x) { return bvec3(_x, _x, _x); }
vec4 bvec4_splat(float _x) { return bvec4(_x, _x, _x, _x); }
